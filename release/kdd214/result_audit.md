...
The canonical computed probe is byte-identical on Python 3.11, 3.12, and 3.13. Maximum raw semantic drift is below 1e-15 absolute; no runtime narrowing was required. Release artifact commit: `f098dc2747ab357c6487a5bec04f36cb70637d3e`; push status: `verified_origin_branch`.
