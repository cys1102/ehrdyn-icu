...
FIGURE_ALLOWLIST = {
    ...
    "benchmark_all_layer_atlas.pdf",
    "benchmark_all_layer_atlas.png",
...
TABLE_ALLOWLIST = {
    ...
    "current_scale_qualified_cell_discrimination.csv",
    "current_scale_qualified_heterogeneous_repeated_dataset_ope_authorization.csv",
    "current_scale_qualified_heterogeneous_repeated_dataset_ope_coverage.csv",
    "current_scale_qualified_heterogeneous_repeated_dataset_ope_gate_summary.csv",
    "current_scale_qualified_heterogeneous_repeated_dataset_ope_rank_and_sign.csv",
    "current_scale_qualified_model_exploitation_all_rows.csv",
    "current_scale_qualified_model_performance_by_cohort.csv",
    "current_scale_qualified_model_performance_task_balanced.csv",
    "current_scale_qualified_policy_true_returns_all_rows.csv",
    "current_scale_qualified_repeated_dataset_ope_authorization.csv",
    "current_scale_qualified_repeated_dataset_ope_coverage.csv",
    "current_scale_qualified_repeated_dataset_ope_gate_summary.csv",
    "current_scale_qualified_repeated_dataset_ope_rank_and_sign.csv",
    "current_scale_qualified_world_model_planner_all_rows.csv",
    ...
    "heterogeneous_repeated_dataset_ope_authorization.csv",
    "heterogeneous_repeated_dataset_ope_coverage.csv",
    "heterogeneous_repeated_dataset_ope_mechanism_summary.csv",
    "heterogeneous_repeated_dataset_ope_rank_and_sign.csv",
    ...
    "primary_cohort_scale_eligibility.csv",
...
SOURCE_CODE_ALLOWLIST = (
    ...
    "kdd_benchmark_discovery/run_kdd115_heterogeneous_repeated_dataset_ope.py",
    ...
    "configs/kdd115_heterogeneous_repeated_dataset_ope_v1.json",
    ...
    "tests/test_kdd115_heterogeneous_repeated_dataset_ope.py",
